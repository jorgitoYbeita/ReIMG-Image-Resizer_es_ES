...
$lang = array_merge($lang, array(
	...
	'reimg_zooming_methods'			=> array(
		...
		'_highslide'	=> array(
								'Use link to download Highslide JS ZIP package. Then place zip packageâ€™s <em>highslide</em> directory in your forumâ€™s <em>reimg</em> directory.',
								'<a href="http://highslide.com/download.php" style="text-decoration: underline;">Highslide</a>',
							),
		'_lytebox'		=> array(
								'Use link to download Lytebox ZIP package. Unzip contents to an empty <em>lytebox</em> directory and place folder in your forumâ€™s <em>reimg</em> directory. DOES NOT WORK WELL WITH INTERNET EXPLORER 9 UNLESS X-UA-Compatible TAG IS CHANGED IN overall_header.html TO JUST HAVE "EmulateIE7" AS THE VALUE FOR "content".',
